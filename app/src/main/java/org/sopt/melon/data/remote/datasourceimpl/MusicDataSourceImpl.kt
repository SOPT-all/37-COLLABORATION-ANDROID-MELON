...
class MusicDataSourceImpl @Inject constructor(
    ...
    override suspend fun getPopularMusicList(): BaseResponse<List<MusicDto>> =
        service.getPopularMusicList()

    override suspend fun getNewestMusicList(category: String): BaseResponse<List<MusicDto>> =
        service.getNewestMusicList(category)

    override suspend fun getChartMusicList(): BaseResponse<List<MusicDto>> =
        service.getChartMusicList()
}
